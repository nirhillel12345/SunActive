...
const redis = new ioredis_1.default(REDIS_URL); // snapshots
const sub = new ioredis_1.default(REDIS_URL); // pub/sub
const wss = new ws_1.WebSocketServer({ port: WS_PORT, path: '/ws' });
