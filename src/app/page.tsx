    ...
    <div>
      <div className="mb-6">
        {!session ? (
          ...
          <div className="rounded-lg p-4 bg-white shadow flex items-center justify-between">
            <div>
            ...
            <div className="flex gap-3">
              ...
              {userRole === 'USER' && (
                <a href="/portfolio" className="px-3 py-2 bg-blue-600 text-white rounded">Your Portfolio</a>
              )}
            </div>
          </div>
        )}
