      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <Card className="md:col-span-2">
          ...
          <div className="space-y-2">
            {ledgers.map((l) => (<div key={l.id} className="p-3 border rounded flex items-start justify-between">
                <div>
        ...
        <Card className="md:col-span-2 mt-4">
          ...
          <div className="space-y-2">
            ...
            {openBets.map((b) => (<div key={b.id} className="p-3 border rounded flex items-start justify-between">
